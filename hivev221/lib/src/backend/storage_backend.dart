...
export 'package:hivev221/src/backend/stub/backend_manager.dart'
    if (dart.library.io) 'package:hivev221/src/backend/vm/backend_manager.dart'
    if (dart.library.html) 'package:hivev221/src/backend/js/backend_manager.dart';
